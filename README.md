...
- `time_to_die` (in milliseconds): If a philosopher has not started eating withing `time_to_die` milliseconds since the start of their last meal or the start of the simulation, they die.
