#if !defined CUT_OUTPUT_H && !defined CUT_H
#define CUT_OUTPUT_H
...
/**
 * Prints styled and formatted content to a given file descriptor.
 *
 * @param fd A file descriptor
 * @param style A string corresponding to a certain style.
 * As a best practice, this argument should correspond to one of the macros
 * defined in cut's output.h file.
 * If NULL, the content will be printed in the default style 
 * @param fmt The format of the content to be printed
 * @param ... Variable list of arguments to complete the given format
 */
